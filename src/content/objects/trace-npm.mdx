...
**Provenance.** Originally developed under Ghalvera and published on npm under that identity; the package name and publication history are preserved. Active development continues here, in Sekiya's Systems & Security area.
